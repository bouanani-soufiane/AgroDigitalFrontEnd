  ...
  const defaultProps = {
    ...
    <div className=" ">
      ...
      <div className='gap-12 pt-12 py-12 mx-auto flex sm:flex-nowrap flex-wrap'>
        <div className="lg:w-100 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden  flex items-end justify-start relative">
        ...
        <div className="lg:w-100 md:w-1/2 bg-gray-300 dark:bg-white rounded-lg overflow-hidden w-full flex items-end justify-start ">
          <div className="max-w-md p-8 mx-auto rounded-lg dark:bg-gray-50 dark:text-gray-800" bis_skin_checked="1">
            <div className="flex justify-between space-x-8" bis_skin_checked="1">
            ...
            <div className="flex justify-between mt-8 space-x-4 dark:text-gray-600" bis_skin_checked="1">
              <div className="flex flex-col items-center space-y-1" bis_skin_checked="1">
      ...
      <div className='  mx-auto flex sm:flex-nowrap flex-wrap'>
        <div className="lg:w-full md:w-100 bg-gray-300 rounded-lg overflow-hidden  p-10 flex items-end justify-start relative">test</div>
