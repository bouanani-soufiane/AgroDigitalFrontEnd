                                    ...
                                    <div className="max-w-md mx-auto">
                                        <form className="dark:bg-[#343338] shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white" id="quantity" type="number" name="description" placeholder="description" />
                                            </div>
                        ...
                        <tbody className="w-full">
                            <tr>
                                ...
                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                    <div className="flex items-center">
                                        <div>
                                            <div className="text-sm leading-5 text-gray-900 dark:text-white">mildio</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-gray-900 dark:text-white text-sm leading-5">Lorem ipsum dolor sit amet </td>


                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-gray-900 dark:text-white text-sm leading-5">abiotqiue </td>
